 ...
 * See the technical information in the documentation of 
 * the {@link In} class, which applies to this class as well.
 * <p> 
 * See 
...
public final class StdIn {
    ...
    // this dummy constructor makes sure no constructor appears 
    // on the javadoc documentation
    private StdIn() {}
     ...
     * Use this to know whether the next call to {@link #readLine()} 
     * will succeed.
     ...
     * Use this to know whether the next call to {@link #readChar()} 
     * will succeed.
     ...
     * Uses whitespaces (space, tab, newline, etc.)
     * as delimiters.
     */
